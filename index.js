...
// If more than one lomgest word, put into an array
// example. longestWord('Hello, my name is Brad') === 'hello',
// example. longestWord('Hello there, my name is Brad') === ['hello', 'there']
...
//example. chunkArray([1, 2, 3, 4, 5, 6, 7], 2) === [[1, 2], [3, 4], [5, 6], [7]]
